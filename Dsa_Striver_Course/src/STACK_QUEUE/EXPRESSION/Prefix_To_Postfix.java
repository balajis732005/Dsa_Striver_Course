...
1)If ch==Operator -> take last two peeks(p1,p2) and popout p1,p2 and push new string p1+p2+ch to stack
...
public class Prefix_To_Postfix {
    public static void main(String[] args) {
        ...
        System.out.println("POSTFIX EXPRESSION FROM INFIX EXPRESSIONS : " +preFixToPostfix(preFixExpression));
    }
